...
#   • FFT enhancement + duotone for harsh, artistic output
# =============================================================================
...
function input_hash()
    ...
    string(hash(take!(s)))   # built‑in UInt64 hash
end
...
if need_train
    println("\n===== Preparing GAN =====")
    # Rebuild images_data (same as before)
    images_data = Vector{Float32}[]
    for f in style_files
    ...
    # Load GAN model (we still need generator for completeness, but not used for fract art)
...
# =============================================================================
# 17. Mathematical art loop – only PCA images, with FFT
# =============================================================================

println("\n===== IMAGE-CONDITIONED MATHEMATICAL ART (PCA + FFT) =====")
...
Post‑modern art (FFT):     $FRACT_OUTPUT
===============================================================================
""")